    ...
    <div class="col3">
        ...
        <div class="col3_center">
            ...
            <div class="section">
                ...
                @csrf
                        <p class="error" align="center">{{Session::get('msg')}}</p>
                        <ul class="forms">
                        ...
                        <ul class="forms">
                            ...
                            <li class="inputfield"><textarea name="remark" cols='28' rows='4' value="<?php 
								//if(!empty($address)) echo $address;?>"></textarea></li>
                        </ul>
                        <div style='with:100%;float:left'><button type="submit">Agree</button></div>
