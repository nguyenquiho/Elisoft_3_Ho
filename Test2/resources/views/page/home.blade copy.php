                    ...
                    @foreach($departments as $de)
                        <li class="dir"><span class="colr navihead bold">{{$de['name']}}</span>
                            ...
                            @if($cat['department_id'] == $de['id'])
                                <li><a href="categories.html">{{$cat['name']}}</a></li>
                            @endif
                            @endforeach
                            </ul>
                        </li>
            ...
            <a href="javascript:void(null)" class="prev">&nbsp;</a>
       	  <div class="anyClass scrol">
                <ul>
                    ...
                    <li>
                    	<a href="detail.html"><img src="images/product/{{$pr['img_url']}}" alt="" ></a>
            ...
            <div class="listing">
                ...
                <?php $i = 1;?>
                    @foreach($new_products as $pr)
                        ...
                        @endif
                        <?php $i ++;?>
                    	<a href="detail.html" class="thumb"><img src="images/product/{{$pr['img_url']}}" alt="" ></a>
                        <h6 class="colr">{{$pr['name']}}</h6>
                        <div class="stars">
