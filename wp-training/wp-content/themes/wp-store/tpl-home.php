...
<div class="ed-container">
		...
		if($cta_section == '1'):
			...
			<div id='cta-section'>
				...
				<div class="cta-content">
					...
					<?php if( !empty( $cta_readmore_link ) ):?>
	...
	?>
		<div id="blog-section">
			<?php 
			$th_blog_title = get_theme_mod('wp_store_homepage_setting_blog_title',esc_html__('Get Updated Blogs','wp-store'));
			$blog_category = get_theme_mod('wp_store_homepage_setting_blog_category', '' );
			?>
			<h3 class="section-title"><span><?php echo esc_html($th_blog_title);?></span></h3>
			<?php
	...
	?>
		<div id="brand-section">
			<?php 
			$brand_title = get_theme_mod('wp_store_homepage_setting_brand_title', esc_html__('Brands We Have','wp-store'));
