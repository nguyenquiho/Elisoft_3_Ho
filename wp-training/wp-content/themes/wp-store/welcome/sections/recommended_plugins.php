					...
					<div class="recom-plugin-wrap">
						<div class="plugin-title-install clearfix">
							...
							<span class="plugin-action-btn plugin-btn-wrapper plugin-card-<?php echo esc_attr($plugin['slug']); ?>">
								<a class="<?php echo esc_attr($btn_class); ?>" data-host-type="<?php echo esc_attr($plugin['host_type']); ?>" data-file="<?php echo esc_attr($plugin['filename']); ?>" data-class="<?php echo esc_attr($plugin['class']); ?>" data-slug="<?php echo esc_attr($plugin['slug']); ?>" href="<?php echo esc_attr($th_link); ?>"><?php echo esc_html($label); ?></a>
							</span>
							<div class="plugin-img-wrap">
							<div class="version-author-info">
								<span class="version"><?php echo esc_html__('Version ', 'wp-store') . esc_html($plugin['version']); ?></span>
			...
			?>
				<div class="recom-plugin-wrap">
					<div class="plugin-title-install clearfix">
						...
						<div class="plugin-img-wrap">
						<div class="version-author-info">
							<span class="version"><?php echo esc_html__('Version ', 'wp-store') . esc_html($info->version); ?></span>
							<span class="seperator">|</span>
