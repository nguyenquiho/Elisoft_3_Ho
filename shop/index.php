        	...
        	<ul class="links">
                ...
                <?php
                    if(isset($_SESSION['user'])){ ?>
                        ...
                        <li class="">Xin chào <a href="#" style="color:#e30000"><?php echo $_SESSION['user']['name']; ?></a></li>
                        <li class="last"><a href="usset_session.php">Log Out</a></li>
                   <?php }else{ ?>
                    <li class="last"><a href="index.php?module=login">Log In</a></li>
                  <?php } ?>
            ...
            <ul id="nav" class="dropdown dropdown-linear dropdown-columnar">
                ...
                <li class="dir"><a href="#">Comforters</a>
                    <ul class="bordergr big">
                        <?php
                            while($department = $getDepartments->fetch_row()) { ?>
                                <li class="dir"><span class="colr navihead bold"><?php echo $department[1]; ?></span>
                                    <ul>
                                    <?php
                                        while($category = $getCategorys->fetch_row()) { 
                                            if($department[0] == $category[2]){ ?>
                                                <li><a href="categories.php?cat=<?php echo $category[0] ?>"><?php echo $category[1]; ?></a></li>
                                            <?php }
                                                ?>
                                            <?php }
                                            mysqli_data_seek($getCategorys,0);
                                         ?>
                                    </ul>
                                </li>
                        <?php } ?>
                ...
                <li><a href="login.php">BedSheets</a></li>
                <li class="dir"><a href="#">Pages</a>
                    <ul class="bordergr small">
                        <li class="dir"><span class="colr navihead bold">Pages</span>
                            <ul>
                                <li class="clear"><a href="index.php?module=home">Home Page</a></li>
                                <li class="clear"><a href="account.php">Account Page</a></li>
                                <li class="clear"><a href="cart.php">Shopping Cart Page</a></li>
                                <li class="clear"><a href="categories.php">Categories</a></li>
                                <li class="clear"><a href="detail.php?module=detail">Product Detail Page</a></li>
                                <li class="clear"><a href="listing.php?module=listing">Listing Page</a></li>
                                <li class="clear"><a href="index.php?module=login">Login Page</a></li>
                                <li class="clear"><a href="static.php">Static Page</a></li>
                                <li class="clear"><a href="contact.php">Contact Page</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
        ...
        <?php  }else{ ?>
        	...
        	<!-- Categories -->
                <div class="category">
                    ...
                    <?php
                    mysqli_data_seek($getDepartments,0);
                    while($department = $getDepartments->fetch_row()) { ?>
                        <a class="menuitem submenuheader" href="#" ><?php echo $department[1]; ?></a>
                        <div class="submenu">
                            <ul>
                                <?php
                                mysqli_data_seek($getCategorys,0);
                                while($category = $getCategorys->fetch_row()) { 
                                    if($department[0] == $category[2]){ ?>
                                        <li><a href="index.php?module=listing&cat=<?php echo $category[0] ?>&page=1"><?php echo $category[1]; ?></a></li>
                                    <?php }
                                        ?>
                                    <?php }
                                    mysqli_data_seek($getCategorys,0);
                ...
                <div class="mycart">
                    ...
                    <div class="small_heading">
                        <h5>My Cart</h5>
                        <div class="clear"></div>
                        <span class="veiwitems">(3) Items - <a href="cart.php" class="colr">View Cart</a></span>
                    </div>
                    <ul>
                        <li>
                            <p class="bold title">
