            ...
            <div class="sorting">
                ...
                <ul class="right">                	
                    ...
                    <?php
						...
						{
					?>
                        	<a <?php if($i == $page) echo 'class="current"' ?> href="?cid=<?=$cid?>&page=<?=$i?>&sort=<?=$sort?>" class="colr"><?=$i?></a> 
                    <?php
						}
					?>
                    </li>
                ...
                <ul class="right">
                	<li class="text">
                    	Sort by Position
                    	<a href="?cid=<?=$cid?>&page=1&sort=<?php if($sort == 1)echo 2;else echo 1 ?>" class="colr <?php if($sort < 3) echo 'current' ?>">Name 
                        <?php
                        ...
                        <a href="?cid=<?=$cid?>&page=1&sort=<?php if($sort == 3)echo 4;else echo 3 ?>" class="colr <?php if($sort > 2) echo 'current' ?>">Price
                         <?php
